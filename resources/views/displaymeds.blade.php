...
<nav class="navbar navbar-expand-lg bg-light">
  ...
  <div class="main">
    ...
    <h1 class='center'><span class='green'> Search</span> <span class='blue'> Medicine</span> </h1>
    <div class='box ' >
      <form action="showmeds" method="post" >
        @csrf
        <input type='search' name='name' placeholder='Enter Medicine Name'>
    ...
    <table class="table my-4 text-center">
        ...
        <tbody>
            ...
            <td>{{$med->price}}</td>
            <td>
                <a href="{{url('/addcart')}}/{{$med->medicine_id}}" class="bttn">Add to Cart</a>
            </td>
            </tr>
            @endforeach
        </tbody>
